...
First real release of the CLI, rewired to work end-to-end against the actual `@klappay/node`/`@klappay/types` packages instead of the placeholder `@klappay/sdk` dependency it shipped with.
